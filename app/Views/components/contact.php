<h1 class="text-center text-2xl text-blue-600 font-semibold mt-5 mb-5"> CONTACT US </h1>
<section id="contact" class="flex flex-col max-w-5xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 md:flex-row md:h-48">
