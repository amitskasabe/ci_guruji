    ...
    <div class="flex flex-wrap mb-24 -mx-4">
        ...
        <div class="sticky top-0 overflow-hidden">
          <div class="relative mb-6 lg:mb-10 lg:h-96">
            ...
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                class="w-5 h-5 text-fuchsia-500 bi bi-chevron-left dark:text-fuchsia-200"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
            ...
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                class="w-5 h-5 text-fuchsia-500 bi bi-chevron-right dark:text-fuchsia-200"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
          ...
          <div class="flex-wrap hidden -mx-2 md:flex">
            <div class="w-1/2 p-2 sm:w-1/4">
              <a
                class="block border border-gray-200 hover:border-fuchsia-400 dark:border-gray-700 dark:hover:border-fuchsia-300"
                href="#"
              >
                <img
      ...
      <div class="w-full px-4 md:w-1/2">
        <div class="lg:pl-20">
          <div class="mb-6">
            <span
              class="px-2.5 py-0.5 text-xs text-fuchsia-600 bg-fuchsia-100 dark:bg-gray-700 rounded-xl dark:text-gray-200"
              >New Arrival</span
            >
            <h2
            ...
            <div class="flex flex-wrap items-center mb-6">
              ...
              <a
                class="mb-4 text-xs underline hover:text-fuchsia-600 dark:text-gray-400 dark:hover:text-gray-300 lg:mb-0"
                href="#"
              >
                View the acer store
              </a>
          ...
          <div
            class="py-6 mb-6 border-t border-b border-gray-200 dark:border-gray-700"
          >
            <span class="text-base text-gray-600 dark:text-gray-400"
              >In Stock</span
            >
            <p class="mt-2 text-sm text-fuchsia-500 dark:text-fuchsia-200">
              Ships from china.
          ...
          <div class="flex flex-wrap items-center mb-6">
            ...
            <div class="mb-4 lg:mb-0">
              <button
                class="flex items-center justify-center w-full h-10 p-2 mr-4 text-gray-700 border border-gray-300 lg:w-11 hover:text-gray-50 dark:text-gray-200 dark:border-fuchsia-600 hover:bg-fuchsia-600 hover:border-fuchsia-600 dark:bg-fuchsia-600 dark:hover:bg-fuchsia-500 dark:hover:border-fuchsia-500 dark:hover:text-gray-100"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
            ...
            <a
              href="#"
              class="w-full px-4 py-3 text-center text-fuchsia-600 bg-fuchsia-100 border border-fuchsia-600 dark:hover:bg-gray-900 dark:text-gray-400 dark:border-gray-700 dark:bg-gray-700 hover:bg-fuchsia-600 hover:text-gray-100 lg:w-1/2 rounded-xl"
            >
              Add to cart
            </a>
          </div>
          <div class="flex gap-4 mb-6">
            <a
              href="#"
              class="w-full px-4 py-3 text-center text-gray-100 bg-fuchsia-600 border border-transparent dark:border-gray-700 hover:border-fuchsia-500 hover:text-fuchsia-700 hover:bg-fuchsia-100 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-900 rounded-xl"
            >
              Buy now</a
            >
          </div>
